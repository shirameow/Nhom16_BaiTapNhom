        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">
                            <h4 class="title">Tạo Hội Đồng</h4>
                                ...
                                <tbody>
                                    <tr>                                        
                                        ...
                                        <td> 
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="text" class="col-md-12 form-control border-input" placeholder="Mã Hội Đồng" value="" name="MaHD">  
                                                </div>
                                            </div>
                                        </td>    
                                        <td></td>
                                    ...
                                    <tr>                                        
                                        ...
                                        <td> 
                                        	<div class="row">
                                                <div class="col-md-12">
                                                    <input type="text" class="col-md-12 form-control border-input" placeholder="Tên Hội Đồng" value="" name="TenHD">  
                                                </div>
                                            </div>
                                        </td>    
                                        <td></td>
                                 ...
                                 <c:if test="${messHD != null}">
						<h3 class="" style="text-align: center;color: #f44336;">${messHD}</h3>
					</c:if>
                            </table>
