								...
								<div class="content table-responsive table-full-width">
									<table class="table table-striped">
										...
										<tbody>
											...
											<c:if
												test="${accAdminXem.role.equals('Sinh Viên') ||accAdminXem.role.equals('Giảng Viên')}">
												<tr>
													<td>Bộ Môn</td>
													<td>
														<div class="row">
											...
											<c:if test="${accAdminXem.role.equals('Giảng Viên')}">
												<tr>
													<td>Hội đồng</td>
													<td>
														<div class="row">
