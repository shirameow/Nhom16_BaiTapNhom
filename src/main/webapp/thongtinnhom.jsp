				...
				<div class="row">
					...
					<div class="col-md-12">
						<c:if test="${Info.getNhom() == 0 }">
							<div class="card">
								<div class="header">
									<h5 class="title">Bạn vẫn chưa có nhóm. Hãy tạo một nhóm
										mới hoặc liên hệ một nhóm để được thêm vào.</h5>
								</div>
								<div class="header">
									<h4 class="title">Danh sách nhóm</h4>
								</div>
								<div class="text-right" style="margin-right: 50px;">
									<a href="trang-dang-ky-nhom"><button type="submit"
											class="btn btn-info btn-fill btn-wd">Đăng kí nhóm</button></a>
								</div>
								<div class="content table-responsive table-full-width">
									<table class="table table-striped">
										...
										<tbody>
											...
											<c:forEach items="${listNhom}" var="nh">
												<tr>
						...
						<c:if test="${Info.getNhom() != 0}">
							<div class="card">
								...
								<c:if test="${Info.getNhomTruong() == 1 }">
									<div class="text-right" style="margin-right: 50px;">
										<a href="them-thanh-vien-nhom"><button type="submit"
												class="btn btn-info btn-fill btn-wd">Thêm thành
												viên</button></a>
									</div>
								</c:if>
								<div class="content table-responsive table-full-width">
												...
												<tr>
													...
													<td><c:if test="${Info.getNhomTruong() == 1 }">
															<div class="text-center">
																<c:if test="${tv.getNhomTruong() == 0 }">
																<a
																	href="xoa-thanh-vien-nhom?mssv=${tv.getId()}">
																	<button type="submit"
