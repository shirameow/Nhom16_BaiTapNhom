...
<form action="xac-nhan-them-thanh-vien-HD">
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">
                            <h4 class="title">Thêm thành viên</h4>
                        ...
                        <div class="content table-responsive table-full-width">
                                ...
                                <tbody>
                                     ...
                                     <tr>                                        
                                        ...
                                        <td> 
                                        	<div class="row">
                                                <div class="col-md-12">
                                                    <select name="giangvien" class="form-select col-md-12 form-control border-input" aria-label="Default select example">
                                                    <!-- <option selected>Chọn Giảng Viên</option> -->
                                                    <c:forEach items="${listGVNHD}" var="gv">
                            ...
                            <c:if test="${messTGV != null}">
						<h3 class="" style="text-align: center;color: #f44336;">${messTGV}</h3>
					</c:if>
                        </div>
                    </div>
                </div>
